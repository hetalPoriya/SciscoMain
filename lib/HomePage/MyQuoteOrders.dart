...
import 'package:scisco/HomePage/my_order_details_place_order.dart';
...
class MyQuoteOrders extends StatefulWidget {
  @override
  _MyQuoteOrdersState createState() => _MyQuoteOrdersState();
}

class _MyQuoteOrdersState extends State<MyQuoteOrders>
    with TickerProviderStateMixin, AutomaticKeepAliveClientMixin<MyQuoteOrders> {
                ...
                InkWell(
                  onTap: (){
                    ...
                    Navigator.pushAndRemoveUntil(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return MyOrdersDetailPlaceOrder(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text(myordersdatum[index].orderstaus,style: TextStyle(fontWeight: FontWeight.w800,fontSize: 12,fontFamily: AppTheme.fontName),)
  ...
  Future<Response> my_orderReq() async {
    ...
    if (isDeviceOnline) {
      try {
        ...
        print(body.toString());
        Response response = await baseApi.dio.post(myQuoteOrderUrl, data: body);
