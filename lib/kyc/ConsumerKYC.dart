...
class ConsumerKYC extends StatefulWidget {
  @override
  _ConsumerKYCState createState() => _ConsumerKYCState();
}

class _ConsumerKYCState extends State<ConsumerKYC> {
