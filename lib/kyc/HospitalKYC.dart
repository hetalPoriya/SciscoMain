...
class HospitalKYC extends StatefulWidget {
  @override
  _HospitalKYCState createState() => _HospitalKYCState();
}

class _HospitalKYCState extends State<HospitalKYC> {
  final _panNoCtrl = TextEditingController();
  final _hospitalRegistrationNoCtrl = TextEditingController();
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextFieldContainer(
              child: TextField(
                controller: _hospitalRegistrationNoCtrl,
                keyboardType: TextInputType.name,
                cursorColor: AppTheme.nearlyBlack,
                decoration: InputDecoration(
                  hintText: "Hospital Registration No.",
                  border: InputBorder.none,
                ),
              ),
            ),
            ...
            RoundedButton(
              ...
              press: () {
                ...
                } else if (_hospitalRegistrationNoCtrl.text
                    .toString()
                    .isEmpty) {
                  _showMyDialog(
                      context, "Please Enter Hospital Registration Number");
  ...
  Future<Response> submitKYCReq() async {
    ...
    try {
      ...
      Map<String, dynamic> formData = {
        ...
        "hospital_reg_no": _hospitalRegistrationNoCtrl.text.toString(),
      };
