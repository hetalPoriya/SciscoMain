...
class PlaceApiProvider {
  ...
  static final String androidKey = "AIzaSyBxgIEW92A9B2xrRBHQJH3YarmlNZlNghY";
  static final String iosKey = 'AIzaSyBxgIEW92A9B2xrRBHQJH3YarmlNZlNghY';
  ...
  Future<Place> getPlaceDetailFromId(String placeId) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (result['status'] == 'OK') {
        ...
        print(place.lat.toString()+" "+place.lng.toString()+" LOCATION");
