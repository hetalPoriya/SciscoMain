...
import 'package:scisco/models/BrandByProductDatum.dart';
import 'package:scisco/models/BrandByProductModel.dart';
...
class BrandByProduct extends StatefulWidget {

  const BrandByProduct({
    Key key,
    this.id,
    this.page_name,
  }) : super(key: key);
  ...
  @override
  _BrandByProductState createState() => _BrandByProductState(this.id,this.page_name);
}

class _BrandByProductState extends State<BrandByProduct> {

  String id;
  String page_name;
  _BrandByProductState(this.id,this.page_name);
  List<BrandByProductDatum> brandByProductList = List();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
          ...
          child: brandByProductList.length > 0
              ? GridView.count(
              shrinkWrap: true,
              ...
              crossAxisCount: 2,
              primary: false,
              children: List.generate(brandByProductList.length, (index) {
                return
                  InkWell(
                    onTap: (){
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) {
                            return MyHomePage(
                                id: brandByProductList[index].id,
                                superCategoryName: brandByProductList[index].superCategory,
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Image.network(
                              brandByProductList[index].image,
                          ...
                          Padding(
                            ...
                            child: Center(
                              child: Text(
                                brandByProductList[index].superCategory,
                                style: TextStyle(
  ...
  Future<Response> getBrandById() async {
    ...
    if (isDeviceOnline) {
      ...
      try {
        ...
        Response response = await baseApi.dio.post(brandListOrderBy, data: body);
        ...
        if (response != null) {
          ...
          var brandByProductModel = BrandByProductModel.fromJson(parsed);

          if (brandByProductModel.error == "1") {
            setState(() {
              brandByProductList = brandByProductModel.data;
            });
          } else {
            String error_msg = brandByProductModel.error_msg;
          }
        }
